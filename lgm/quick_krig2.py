...
for msel in range(12):    
    ...
    ## only will use krigging north of this latitude
    ...
    fname_krig = 'lgmDA_lgm_SST_monthly_climo_krigged_' + mstring + '.nc'
    fname_merged = 'lgmDA_lgm_SST_monthly_climo_merged_' + mstring + '.nc'
